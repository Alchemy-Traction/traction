...
module.exports = class UserService {
  ...
  static async create({ phoneNumber }) {
    ...
    const user = await User
      .insert({ phoneNumber })
      .then(console.log)  //remove this later
      .then((user) => sendSms(user, 'Thanks for signing up to Tracktion! You are on your way to building healthy habits! Let\'s start with a picture, send me a selfie!'));
