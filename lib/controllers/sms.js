...
module.exports = Router()
  .post('/', async(req, res, next) => {
    ...
    console.log('below is sms.js line 28');
    console.log(habits); //alternatively a const latestHabit = Habit.findLatest()
    ...
    } else if(!user.user_photo_url) { /// HERE IS WHERE WE ARE LEFT OFF
    ...
    } else if(latestHabit.label === null) { // THIS IS WHERE WE LEFT OFF
